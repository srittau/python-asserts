...
def assert_almost_equal(first: float, second: float, msg: str = ..., places: int = ..., delta: float = ...) -> None: ...
def assert_not_almost_equal(first: float, second: float, msg: str = ..., places: int = ..., delta: float = ...) -> None: ...
